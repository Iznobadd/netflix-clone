...
const Footer = () => {
  ...
  return (
    <div className="bg-[#f3f3f3] text-[#737373] text-[1em] min-w-[190px] pb-[20px] relative w-full">
      <div className="border-t border-t-[#e6e6e6] h-0 w-full"></div>
      <div className="mx-auto pt-[30px] w-[90%]">
        ...
        <div className="inline-block">
          <div className="inline-block w-full max-w-[500px] relative">
            <label
              htmlFor="language"
            ...
            <div className="min-w-[auto] w-auto text-[1rem] text-[#737373] items-center inline-flex gap-[2px] leading-[100%] relative text-left z-[0]">
              ...
              <div className="pr-[0.75rem] border bg-white border-[rgba(128,128,128,0.7)] absolute flex justify-end items-center left-0 top-0 right-0 bottom-0 z-[-1] select-none">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
